...
\begin{document}	
	...
	\section*{Wynik naszego programu dla danych o kuźni}
			\includegraphics[scale=0.5]{kuznia.jpg}\\
			\includegraphics[scale=0.5]{kuznia2.jpg}\\
			\includegraphics[scale=0.5]{kuznia3.jpg}\\
			\includegraphics[scale=0.5]{kuznia4.jpg}\\
			
	
		
	\section{Testy}
	\indent
	\includegraphics[scale=0.6]{przyklad.jpg}\\
	\includegraphics[scale=1]{przyklad2.jpg}\\
	\includegraphics[scale=1]{przyklad3.jpg}\\
	\includegraphics[scale=1]{przyklad4.jpg}
	...
	\textbf{Richard C. Rothermel:} A matematical model for predictig dire spread om wildland fuels, January 1972\\
