...
\begin{document}	
	...
	Kierunek rozwoju tej symulacji jest dla nas oczywisty - w pierwszym kroku należałoby zamodelować rozprzestrzenianie się pożaru w koronach drzew. Następnie możnaby pokusić się o uwzględnienie w sumulacji nie tylko właściwości drzew, ale też ściółki. Należałoby też "zdynamizować" środowisko - uwzględnić fakt, że wiatr, wilgotność powietrza i inne czynniki zmieniają się w czasie.
	\section{Literatura}
	%\indent
