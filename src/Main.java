...
public class Main {
	...
	public static void main(String[] args) 
	{
		...
		System.out.println("Ilosc drzew: " + sum + " " + " na ilosc miejsc: " + board.size*board.size);
		System.out.println("Mozna zmienic ilosc miejsc i prawdopodobienstwo zasadzenia drzew w wywo³aniu konstruktora Board");
	}
